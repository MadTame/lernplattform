...
public class CrmView extends Div {
    ...
    private Dialog createDialog(User user) {
        ...
        binder.forField(usernameField).asRequired("Username is required").bind(User::getUsername, User::setUsername);
        binder.forField(rolesCheckboxGroup).asRequired("At least one role is required").bind(
                User::getRoles,
                User::setRoles);
